...
public class InterviewScheduleController {
		...
		private InterviewScheduleService interviewScheduleService;
			...
			public InterviewSchedule giveRatingToCandidate(@PathVariable("id") int interviewID) throws CandidateNotFoundException  {
				
				return interviewScheduleService.giveRatingToCandidate(interviewID);
			}
